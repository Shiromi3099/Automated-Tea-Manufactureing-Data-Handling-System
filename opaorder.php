...
<section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"> <img class="img-fluid" src="<?php echo $imagePaths['OP']; ?>" alt=""> </div>
                    <div class="col-md-6">
                        <div class="small mb-1">Agarapatha Tea Plantation</div>
                        <h1 class="display-5 fw-bolder">Orange Pekoe ‘A’ </h1>
                        <p class="lead"> The Orange Pekoe-A Tea in full, is a fine grade of tea which consists of slightly larger leaves, compared to other Orange Pekoe varieties like OP and OP1. OPA is the Ceylon black tea grade that has the boldest, large size leaves in appearance. Made of long bold and slightly twisted tea leaves. Once brewed, these teas have a rich aromatic forest-like scent and the lighter liquor generally has a light golden reddish color and a delicate lighter taste. This tea takes slightly longer time to brew compared to other teas, but has a unique taste compared to other smaller grades.
                         </p>
                         <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                             <input type="number" name="order_weight" placeholder="Order Weight (in Kg)" required>
                              <input type="hidden" name="tetype" value="OPA"> <!-- Hidden field for tea type -->
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <div class="col mb-5">
                        ...
                        <img class="img-fluid" src="<?php echo $imagePaths['BOPF']; ?>" alt=""> 
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <h5 class="fw-bolder">BOPF</h5>
                                </div>
                            </div>
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="bopforder.php">View options</a></div>
                    ...
                    <div class="col mb-5">
                        ...
                        <img class="img-fluid" src="<?php echo $imagePaths['FBOP']; ?>" alt=""> 
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <h5 class="fw-bolder">FBOP</h5>
                                </div>
                            </div>
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="fboforder.php">View options</a></div>
