...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $tetype = isset($_POST["TeaType"]) ? $_POST["TeaType"] : ""; // check if set to avoid error
    $weight1 = $_POST["Weight1"];
    $count = $_POST["count"];

    $sql = "INSERT INTO packing_dpt (inchargeName, date, startHour, startMinute, endHour, endMinute, employeeCount, tetype, Weight1, count)
            VALUES ('$inchargeName', '$date', '$startHour', '$startMinute', '$endHour', '$endMinute', '$employeeCount', '$tetype', '$weight1', '$count')";
...
<head>
    <meta charset="utf-8">
    <title>Factory officer page</title>
    ...
    <div class="container-fluid">
        ...
        <section class="h-70">
            <div class="container h-70">
                <label class="withering-label">Packing Department</label>
            </div>
        </section>
    </div>
        ...
        <div class="card mt-4">
            <div class="card-body">
                <form id="WitheringForm" action="" method="POST" class="needs-validation" novalidate autocomplete="off">
                    ...
                    <div class="form-row align-items-center">
                        <div class="form-group col-md-4">
                            <label for="inputEmployeeCount" class="mr-2 label-width"><b>Tea Bulk</b></label>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label for="inputTeaType" class="mr-2 label-width">Tea Types</label>
                            <select class="form-control" id="inputTeaType" name="TeaType" required>
                        ...
                        <div class="form-row align-items-center">
                            <div class="form-group col-md-10">
                                <label for="inputCount" class="mr-2 label-width">Count</label>
