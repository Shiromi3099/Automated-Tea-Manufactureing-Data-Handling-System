...
if (isset($_GET['searchName'])) {
    ...
    $query = "SELECT * FROM teaorder WHERE teabuyer_name LIKE '%$searchName%'";
} else {
    $query = "SELECT * FROM teaorder";
}
...
<div class="sidebar pe-4 pb-3">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <form class="d-none d-md-flex ms-4" method="get" action="teaorderlist.php">
            ...
            <div class="container-fluid1 pt-4 px-4">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <tr>
                        ...
                        <td><?php echo isset($row['teabuyer_name']) ? $row['teabuyer_name'] : ''; ?></td>
                        <td><?php echo isset($row['tetype']) ? $row['tetype'] : ''; ?></td>
                        <td><?php echo isset($row['order_weight']) ? $row['order_weight'] : ''; ?></td>
                        <td><?php echo isset($row['order_date']) ? $row['order_date'] : ''; ?></td>
                        <td>
                        <a href="freport.php?order_id=<?php echo $row['order_id']; ?>" class="btn btn-secondary btn-sm">Report</a>
