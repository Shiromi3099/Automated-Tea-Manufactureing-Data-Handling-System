            ...
            <div class="col-lg-8">
                <div class="card mb-4">
                    ...
                    if (isset($_GET['id'])) {
                        ...
                        $sql = "SELECT * FROM packing_dpt WHERE id = $id";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "<div class='row'>";
                            echo "<div class='col-sm-3'>";
                            echo "<p class='mb-0'>Machine Type </p>";
                            echo "</div>";
                            echo "<div class='col-sm-9'>";
                            echo "<p class='text-muted mb-0'>" . $row['mtype'] . "</p>";
                            echo "</div>";
                            echo "</div>";
                            echo "<hr>";
                            echo "<div class='row'>";
                            echo "<div class='col-sm-3'>";
                            echo "<p class='mb-0'>Tea Type </p>";
                            echo "</div>";
                            echo "<div class='col-sm-9'>";
                            echo "<p class='text-muted mb-0'>" . $row['tetype'] . "</p>";
                            echo "</div>";
                            echo "</div>";
                            echo "<hr>";
                            echo "<div class='row'>";
                            ...
                            echo "<div class='row'>";
                            echo "<div class='col-sm-3'>";
                            echo "<p class='mb-0'>Count </p>";
                            echo "</div>";
                            echo "<div class='col-sm-9'>";
                            echo "<p class='text-muted mb-0'>" . $row['count'] . "</p>";
                            echo "</div>";
                            echo "</div>";
                            echo "</div>";
                        } else {
