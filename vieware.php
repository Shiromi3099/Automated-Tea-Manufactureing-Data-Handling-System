        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    <a href="dashaera.php" class="nav-item nav-link">Back</a>
                </div>
            </div>
        </div>
    </nav>
            ...
            <div class="col-lg-8">
                <div class="card mb-4">
                    ...
                    if (isset($_GET['id'])) {
                        ...
                        $sql = "SELECT * FROM aeration_dpt WHERE id = $id";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "<p class='text-muted mb-0'>" . $row['inchargeName'] . "</p>";
                            echo "</div>";
                            echo "</div>";
                            echo "<hr>";
                            echo "<div class='row'>";
                            ...
                            echo "</div>";
                            echo "<div class='col-sm-9'>";
                            echo "<p class='text-muted mb-0'>" . $row['date'] . "</p>";
                            echo "</div>";
                            echo "</div>";
                            echo "<hr>";
                            echo "<div class='row'>";
                            echo "<div class='col-sm-3'>";
                            echo "<p class='mb-0'>Tea Leaf Temperature </p>";
                            echo "</div>";
                            echo "<div class='col-sm-9'>";
                            echo "<p class='text-muted mb-0'>" . $row['teaLeafTemperature'] . "</p>";
                            echo "</div>";
                            echo "</div>";
                            echo "<hr>";
                            echo "<div class='row'>";
                            echo "<div class='col-sm-3'>";
                            echo "<p class='mb-0'>Aeration Method </p>";
                            echo "</div>";
                            echo "<div class='col-sm-9'>";
                            echo "<p class='text-muted mb-0'>" . $row['atype'] . "</p>";
                            echo "</div>";
                            echo "</div>";
                            echo "<hr>";
                            echo "<div class='row'>";
                            echo "<div class='col-sm-3'>";
                            echo "<p class='mb-0'>Raw Material </p>";
                            echo "</div>";
                            echo "<div class='col-sm-9'>";
                            if(isset($row['r_type'])) {
                                echo "<p class='text-muted mb-0'>" . $row['r_type'] . "</p>";
                            } else {
                                echo "<p class='text-muted mb-0'>N/A</p>";
                            }
                            echo "</div>";
                            echo "</div>";
                            echo "<hr>";
                            echo "<div class='row'>";
                            echo "<div class='col-sm-3'>";
                            echo "<p class='mb-0'>Quantity used </p>";
                            echo "</div>";
                            echo "<div class='col-sm-9'>";
                            echo "<p class='text-muted mb-0'>" . $row['measurement'] . "</p>";
                            echo "</div>";
                            echo "</div>";
                            echo "<hr>";
                            echo "<div class='row'>";
                            echo "<div class='col-sm-3'>";
                            echo "<p class='mb-0'>Quantity (kg)</p>";
                            echo "</div>";
                            echo "<div class='col-sm-9'>";
                            echo "<p class='text-muted mb-0'>" . $row['Weight1'] . "</p>";
                            echo "</div>";
                            echo "</div>";
                            echo "</div>";
