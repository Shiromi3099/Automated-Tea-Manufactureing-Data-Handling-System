            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 class="display-5 fw-bolder">Orange Pekoe </h1>
                        <p class="lead"> A whole leaf, well twisted tea. A delicate brew that varies in taste according to the different districts. Less wiry than OP1, but much more twisted than OPA.
                         </p>
                         <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                             <input type="number" name="order_weight" placeholder="Order Weight (in Kg)" required>
                              <input type="hidden" name="tetype" value="OP"> <!-- Hidden field for tea type -->
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <div class="col mb-5">
                        ...
                        <img class="img-fluid" src="<?php echo $imagePaths['BOPF']; ?>" alt=""> 
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="bopforedr.php">View options</a></div>
