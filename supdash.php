...
if (isset($_GET['searchDate'])) {
    ...
    $query = "SELECT * FROM supply WHERE user_id = ? AND DATE(date) = ?";
    $stmt = $conn->prepare($query);
    $stmt->bind_param("is", $user_id, $searchDate);
    $stmt->execute();
    $result = $stmt->get_result();
} else {
    $query = "SELECT * FROM supply WHERE user_id = ?";
    $stmt = $conn->prepare($query);
    ...
    <div class="ms-3">
        ...
        // Fetch username based on user_id
            ...
            ?>
                ...
                <div class="navbar-nav w-100">
                    <a href="supdash.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <form class="d-none d-md-flex ms-4" method="get" action="supdash.php">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <span class="d-none d-lg-inline-flex">Supplier</span>
                        </a>
            ...
            <div class="container-fluid1 pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Supply Report</h6>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            ?>
                              ...
                              <td>
                              <a href="supreport.php?supply_id=<?php echo $row['supply_id']; ?>" class="btn btn-secondary btn-sm">View</a>
                                
                              <a href="supdfdown.php?supply_id=<?php echo $row['supply_id']; ?>" class="btn btn-success btn-sm">Download</a>
